...
public class WelcomeBackActivity extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "oedinn";
    private static final String DUMMY_PASSWORD = "aryasuta115";
...
//    Sharedprefences yang akan digunakan unyuk menulis dan menbaca data
    private SharedPreferences sharedPrefs;

//    Key-key untuk data yang disimpan di Sharedpprefs
...
//Inisialisasi SharedPrefs
    ...
    {
        boolean valid = this.ValidatedCredential();
        if (valid) {
    ...
    private boolean ValidatedCredential(){
